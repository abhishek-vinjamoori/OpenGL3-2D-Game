...
VAO *triangle, *rectangle,*circle[2];
...
void createcircle()
{
  ...
  circle[0] = create3DObject(GL_TRIANGLE_FAN, outerVertexCount, buffer, color_buffer_data, GL_FILL);
...
void draw ()
{
  ...
  translateRectangle = glm::translate (glm::vec3(2, -2, 0));        // glTranslatef
